...
// ---------------------------- SETTINGS -------------------------------
#define NUM_LEDS 32         // number of microcircuits WS28xx on LED strip (note: one WS2811 controls 3 LEDs!)
#define BTN_TIMEOUT 800     // button hold delay, ms
#define BRIGHTNESS 174      // max LED brightness (0 - 255) max 44 for WS2812b 144 
#define MAX_BRIGHTNESS 190      // max LED brightness (0 - 255) max 44 for WS2812b 144 
#define LIGHT_UP_TIME 10 //ms per LED on strip
...
#define DEFAULT_COLOR 2     //1= green, 5 = ice blue
...
void setup() {
  ...
  myDFPlayer.volume(29);  //Set volume value. From 0 to 30
    myDFPlayer.play(R2D2_WAV);  //Play the 30th mp3 ("Much fear I sense in you...")
