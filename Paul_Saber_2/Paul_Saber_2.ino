///Majory modifications I (Paul Simonson) made to the original GyverSaber code to produce this program file:
...
// ---------------------------- SETTINGS -------------------------------
#define NUM_LEDS 144-25         // number of microcircuits WS28xx on LED strip (note: one WS2811 controls 3 LEDs!)
#define BTN_TIMEOUT 800     // button hold delay, ms
#define BRIGHTNESS 51      // max LED brightness (0 - 255) max 44 for WS2812b 144 
#define LIGHT_UP_TIME 1 //ms per LED on strip
...
#define DEFAULT_COLOR 5     //5 = ice blue
...
#define STRIKE_THR 100 * THRESHOLD_MODIFIER     // hit acceleration threshold
...
void setup() {
  ...
  //FastLED.addLeds<WS2813, LED_STRIP_CONTROL_PIN, GRB>(leds, NUM_LEDS); // for GRB LEDs

  FastLED.setBrightness(10);  // ~40% of LED strip brightness
